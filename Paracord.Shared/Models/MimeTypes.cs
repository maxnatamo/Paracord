namespace Paracord.Shared.Models
{
    ...
    {
        /// <summary>
        /// Map for file-extensions and their associated MIME-types.
        /// </summary>
        /// <seealso href="https://developer.mozilla.org/en-US/docs/Web/HTTP/Basics_of_HTTP/MIME_types/Common_types">MDN reference.</seealso>
        ...
        public static string? ResolveMimeType(string path)
        {
            ...
            if(!string.IsNullOrEmpty(extension) && MimeTypes.FileExtensions.ContainsKey(extension))
            {
                return MimeTypes.FileExtensions[extension];
            }
